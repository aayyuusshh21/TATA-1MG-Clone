...
const ListHeader = ({ children }) => {
  return (
    <Text fontWeight={"500"} fontSize={30} mb={2}>
      {children}
    </Text>
  );
};
  ...
  return (
    ...
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid columns={5} spacing={8} fontSize={15} textAlign={"left"}>
          ...
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>Vegan News & Vegetarian Articles</Link>
          ...
          <Stack align={"flex-start"}>
            <ListHeader>PetFinder.my</ListHeader>
